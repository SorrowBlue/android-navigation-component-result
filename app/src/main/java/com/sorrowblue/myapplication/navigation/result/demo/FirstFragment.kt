...
import com.sorrowblue.androidx.navigation.result.observeNavigationResult
...
class FirstFragment : AppFragment(R.layout.fragment_first) {
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
		...
		observeNavigationResult<String>("result") {
            Toast.makeText(requireContext(), "SecondFragment result:$it", Toast.LENGTH_SHORT).show()
        }
//		observeNavigationResult<Int>("100") {
//			Toast.makeText(requireContext(), "#####SecondFragment result:$it#####", Toast.LENGTH_SHORT).show()
//		}
